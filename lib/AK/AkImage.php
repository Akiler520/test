 ...
 *	@package    LIB-Ak
 *
 *	@since      2014-07-21 15:12:45
 *  @usage
    自动裁切:   <br>
    程序会按照图片的尺寸从中部裁切最大的正方形，并按目标尺寸进行缩略    <br>

    $t->setSrcImg("img/test.jpg");  <br>
    $t->setCutType(1);//这一句就OK了 <br>
    $t->setDstImg("tmp/new_test.jpg");  <br>
    $t->createImg(60,60);   <br>
...
// 判断浏览器,若是IE就不发送头
            ...
            switch($func_name){
                case 'imagepng':
                    ...
                    if($this->img_display_quality < 0 || $this->img_display_quality > 9){
